...
<main id="home" class="home">
  ...
  <footer class="home-footer"><span>파일 전송 없음 · 회원가입 없음 · 한글 설치 없이 사용</span><span>심너울 제작 · 버전 1.0 · Apache License 2.0</span></footer>
</main>
<main id="guide" class="guide hidden">
  ...
  <div class="guide-layout"><nav class="guide-index" aria-label="설명서 목차"><a href="#guide-start">사용 순서</a><a href="#guide-scenes">장면 구분</a><a href="#guide-save">저장과 선택 기록</a><a href="#guide-files">지원하는 파일</a><a href="#guide-bugs">버그 제보</a><a href="#guide-about">만든 사람</a></nav><div class="guide-content">
...
두 번째 장면의 첫 문단.</pre><p>↵는 Enter로 문단을 나눈 자리를 나타냅니다.</p></div><p>빈 문단이 여러 개 연속되어도 경계는 하나로 봅니다. 문단 뒤 여백만 넓히거나 Shift + Enter로 줄만 바꾸는 것은 장면 구분이 아닙니다. 제목이나 ‘끝’ 앞에 빈 문단이 있으면 그 부분도 별도 장면으로 표시합니다.</p><p>장면 목록에서 읽을 곳을 고르거나 본문을 검색하세요. 단축키 <kbd>Alt</kbd> + <kbd>←</kbd> / <kbd>→</kbd>는 장면 이동, <kbd>Alt</kbd> + <kbd>↑</kbd> / <kbd>↓</kbd>는 수정 구간 이동입니다.</p></section>
    ...
    <section id="guide-bugs"><span class="eyebrow">05 · 버그 제보</span><h2>문제가 생겼나요?</h2><p>버그가 발생한 문서의 내용과 어떤 문제가 발생했는지 <a href="mailto:neoulshim@gmail.com">neoulshim@gmail.com</a>으로 보내 주세요.</p></section>
    <section id="guide-about" class="about-card"><span class="eyebrow">06 · 이 도구에 대하여</span><h2>심너울이 만들었습니다.</h2><p>원문과 개고본을 나란히 읽고, 남기고 싶은 수정을 고르는 일을 조금 더 편하게 하고 싶었습니다.</p><dl class="about-meta"><div><dt>제작</dt><dd>심너울</dd></div><div><dt>버전</dt><dd>1.0</dd></div><div><dt>라이선스</dt><dd><a href="./LICENSE.txt" target="_blank" rel="noopener">Apache License 2.0 ↗</a></dd></div></dl><div class="author-support"><a class="portfolio-link" href="https://thundering-pedestrian-751.notion.site/648661f180b94517ad1ee6723591d2cd" target="_blank" rel="noopener noreferrer">심너울 포트폴리오 ↗</a><p class="author-support-note"><span class="support-book" aria-hidden="true">📚</span><span><strong>개발자에게 수고했다고 말해주고 싶으신가요?</strong><br>개발자의 포트폴리오를 확인하고 개발자가 쓴 책을 한 권 사주세요!</span></p></div><p class="example-credit">예제 원작: 심너울, 「한 쪽이 너무 유리한 게임」. 저자의 허락을 받아 수록했습니다. 개고안은 비교 기능을 보여주기 위해 AI의 도움으로 만든 수정 제안입니다.</p><p><strong>예제 소설의 원문과 개고안은 별도 허락 없이 수정·재배포하는 앱에 포함할 수 없습니다.</strong> 앱을 수정하여 공개하거나 재배포할 때는 예제를 삭제하거나, 이용·배포할 권리가 있는 원고로 교체해 주세요. <a href="./EXAMPLE_LICENSE.txt" target="_blank" rel="noopener">예제 소설 이용 조건 ↗</a></p><p>앱 코드는 Apache License 2.0에 따라 사용·수정·재배포할 수 있습니다. 수정본을 배포할 때도 <strong>원저작자: 심너울 (NeoulShim)</strong> 고지를 유지하고, 변경한 파일에는 수정 사실을 표시해야 합니다. 자세한 조건은 라이선스 원문과 <a href="./NOTICE.txt" target="_blank" rel="noopener">저작자 고지 ↗</a>를 확인해 주세요.</p><p class="muted"><a href="./THIRD_PARTY_NOTICES.txt" target="_blank" rel="noopener">오픈소스 고지 ↗</a></p></section>
  </div></div>
</main>
